	...
	public virtual void DrawTile()
	{
		...
		if (detail.things.Count > 0 && isSeen)
		{
			...
			for (int j = 0; j < detail.things.Count; j++)
			{
				...
				shadow2 = thingPos.y < 0.16f && num7 < 0.16f;
				_ = pref.bypassShadow;
		...
		if (!sourceFloor.tileType.IsSkipFloor)
		{
			...
			if (isWater)
			{
				...
				{
					Cell cell = (((num26 & 1) != 0) ? this.cell.Back : (((num26 & 2) != 0) ? this.cell.Right : (((num26 & 4) != 0) ? this.cell.Front : this.cell.Left)));
					if (isShoreSand && !cell.sourceFloor.isBeach)
					{
						cell = (((num26 & 8) != 0) ? this.cell.Left : (((num26 & 4) != 0) ? this.cell.Front : (((num26 & 2) != 0) ? this.cell.Right : this.cell.Back)));
					}
					if (!cell.IsSnowTile)
					{
				...
				if (this.cell.Back.isShoreSand && ((this.cell.Back.shore / num25) & 8) != 0 && this.cell.Left.isShoreSand && ((this.cell.Left.shore / num25) & 1) != 0)
				{
					param.tile = 785f;
				...
				if (this.cell.Back.isShoreSand && ((this.cell.Back.shore / num25) & 2) != 0 && this.cell.Right.isShoreSand && ((this.cell.Right.shore / num25) & 1) != 0)
				{
					param.tile = 786f;
				...
				if (this.cell.Front.isShoreSand && ((this.cell.Front.shore / num25) & 2) != 0 && this.cell.Right.isShoreSand && ((this.cell.Right.shore / num25) & 4) != 0)
				{
					param.tile = 787f;
				...
				if (this.cell.Front.isShoreSand && ((this.cell.Front.shore / num25) & 8) != 0 && this.cell.Left.isShoreSand && ((this.cell.Left.shore / num25) & 4) != 0)
				{
					param.tile = 788f;
